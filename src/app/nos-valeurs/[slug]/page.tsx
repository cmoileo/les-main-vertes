        ...
        <main>
            ...
            <article className={"p-[50px] bg-white rounded-[30px] flex items-center gap-[50px]"}>
                <div className={"flex flex-col"}>
                    ...
                    <a className={"mt-[30px] bg-primary-green text-center rounded-full text-[16px] py-[12px] px-[24px] w-fit text-white font-lexend"} href={pageData.bouton.lien}>{pageData.bouton.texte_du_bouton}</a>
                </div>
