...
export const PageLink2 = async ({data, gridColumn}: {data: any, gridColumn: string}) => {
    const titleBaseStyle = 'font-lexend text-white tracking-[-3px] text-[26px] font-semibold text-pretty'
    console.log(gridColumn)

    return (
        <div className={gridColumn}>
            <a className={cn(data.couleur_de_fond, "flex h-full transition cursor-pointer group relative flex-col p-[20px] justify-between rounded-[30px]")}
