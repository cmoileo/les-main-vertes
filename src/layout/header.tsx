...
export default async function MenuComponent() {
    ...
    return (
        <header className={"flex items-center gap-[10px] bg-primary-white rounded-[30px]"}>
            <a href={"/"}>
                <div
                    className={"flex items-center gap-[10px] w-[35%] px-[38px] py-[23px]"}>
                    <Image
                        src={Logo}
            ...
            <nav
                className="menu flex items-center gap-[40px] w-full py-[40px]">
